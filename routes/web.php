...
Route::group(['middleware' => 'auth'], function () {
    ...
    //userlist
    Route::get('user/lists', 'UserList\UserController@index');
    Route::get('user/make-admin/{id}', 'UserList\UserController@make_admin');
    Route::get('user/make-user/{id}', 'UserList\UserController@make_user');
