                ...
                <table id="dataTable" class="table table-striped table-hover table-condensed table-bordered">
                    ...
                    @foreach($table as $row)
                        <tr>
                            ...
                            <td class="text-right"><a href="{{action('Blog\BlogController@del',['id'=>$row->blogID])}}" onclick="return confirm('Are you sure to Delete?')" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></a></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
