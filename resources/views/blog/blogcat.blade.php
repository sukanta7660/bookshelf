                ...
                <table id="dataTable" class="table table-striped table-hover table-condensed table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right"><a href="{{action('Blog\BlogCategoryController@del', ['id' => $row->blogcatID])}}" onclick="return confirm('Are you sure to Delete?')" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></a></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
